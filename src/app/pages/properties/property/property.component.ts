...
export class PropertyComponent implements OnInit {
  ...
  cardDetails: any;
  property_area: any;
  statusOfWaterAndElectricity: any;
  ...
  constructor(public appSettings: AppSettings,
    ...
    private _pageServices: PageServicesService,
    ) {
  ...
  getCardDetails(id){
      this._pageServices.getCardDetails(id).subscribe(res=>{
    ...
    this._pageServices.getPropertyById(id).subscribe(res => {
      ...
      if(propertyType === 'Residential'){
        ...
        this.property = {
          ...
          "property_features": ele.property_features,
          "area": {
            "value": ele?.commercial_details?.plotArea,
            "unit": "Sq-ft"
          },
          // "yearBuilt": 2007,
          // "property_posted_on":ele.property_posted_on,
  ...
  getPropertyTypeController() {
    this._pageServices.getPropertyTypeController().pipe(takeUntil(this.notifier)).subscribe((res: any) => {
