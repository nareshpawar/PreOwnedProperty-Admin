...
export class AgentsComponent implements OnInit {
  ...
  editData(element){
    ...
    this.agentForm.controls.agent_id.setValue(element.agent_id);
    this.agentForm.controls.agent_desc.setValue(element.agent_desc);
    this.agentForm.controls.agent_name.setValue(element.agent_name);
    this.agentForm.controls.contact.setValue(element.contact);
    this.agentForm.controls.email.setValue(element.email);
    this.agentForm.controls.organisation.setValue(element.organisation);
