...
export class OurMissionComponent implements OnInit {
  ...
  submitMission(){
      let mission=  { id : this.missionForm.controls.id.value,
                      missionModels : this.missionForm.controls.missionModels.value};
      let id = this.missionForm.controls.id.value;
  ...
  editData(element){
    ...
    this.missionForm.controls.id.setValue(element.id);
