...
export const routes: Routes = [
    { 
        ...
        component: PagesComponent, children: [
            ...
            // { path: 'home', loadChildren: () => import('./pages/admin-properties-page/admin-properties.module').then(m =>m.AdminPropertiesModule) },
            ...
            { path: 'master-data', loadChildren: () => import('./pages/masterPages/master-data.module').then(m => m.MasterDataModule) },
            { path: 'adminProperties', loadChildren: () => import('./pages/admin-properties-page/admin-properties.module').then(m =>m.AdminPropertiesModule) },
